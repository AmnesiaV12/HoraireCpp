...
void Essai1()
{
  ...
  // ...
  catch (const planning::TimeException& e) {
        // Si l'exception est de type TimeException
        cerr << "Erreur attrapée : " << e.getMessage() << " (Code d'erreur : " << e.getCode() << ")" << endl;
  } catch (...) { 
    // Catch générique pour toute autre exception
...
void Essai2()
{
  ...
  // ...
      ...
      cerr << "Erreur TimeException attrapée : " << e.getMessage() << endl;
      cerr << "Code d'erreur : " << e.getCode() << endl;
  }
...
void Essai10()
{
  ...
  // ...
  catch (const planning::TimingException& e) {
      cerr << "Erreur lors de la création de l'objet Timing : " << e.getMessage() << endl;
      cerr << "Code d'erreur : " << e.getCode() << endl;
  } catch (const planning::TimeException& e) {
      cerr << "Erreur dans l'objet Time : " << e.getMessage() << endl;
      cerr << "Code d'erreur : " << e.getCode() << endl;      
  }
